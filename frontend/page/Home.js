      ...
      <ScrollView>
            ...
            <View style={styles.bottomcategory}>
              <View style={styles.categoryBottomCard}>
                  <TouchableOpacity onPress={() => {navigation.navigate("OnlineConsultation");
                    }}
                  >
                    <Image
            ...
            <View style={styles.informationcode}>
                <Text style={styles.informationText}>"Mental health... is not a destination, but a process.
                It's about how you drive,not where you're going." --Noam Sphancer </Text>
            </View>
            <View style={styles.informationcode1}>
                <Text style={styles.informationText}>"Not until we lost do we begin to understand ourselves." 
                --Henry David Thoreau </Text>
            </View>
            <View style={styles.informationcode}>
                <Text style={styles.informationText}>"Happiness can be found even in the darkest of times, if one 
                only remembers to turn on the light."--Albus Dumbledore</Text>
            </View>
          </ScrollView>
        <BottomNav/>
    </View>

        ...
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <View style={styles.homeBox}>
                    ...
                    <Image style={styles.charcterImage} source={require('../assets/blueBlob.png')}/>
                </View>
                ...
                <TouchableOpacity>
                    <View style={styles.doctorBox}>
                        ...
                        <View style={styles.rightside}>
                            <Image source={require('../assets/ocDoc-1.png')} style={styles.doctorImage}/>
                        </View>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity>
                    <View style={styles.doctorBox}>
                        ...
                        <View style={styles.rightside}>
                            <Image source={require('../assets/ocDoc-2.png')} style={styles.doctorImage}/>
                        </View>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity>
